...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      if (!autoColors) {
        ...
        return {
          r: Math.min(1, base + jitter()),
          g: Math.min(1, base + jitter()),
          b: Math.min(1, base + jitter()),
        };
      }
  ...
  return (
    <div
      className={`pointer-events-none fixed left-0 top-0 z-40 h-full w-full cursor-none ${className}`.trim()}
    >
